  ...
  theme: {
    ...
    extend: {
      spacing: {
        ...
        "44px" : "44px",
        "84px" : "84px",
        "image-circle-sm": "80px",
        "image-circle-lg": "160px",
      },
      width: {
        "sidebar" : "68px",
        "main-left" : "56px",
      ...
      fontFamily: {
        ...
        'body': ['Finador-Regular', 'sans-serif'],
        'quote': ['Finador-RegularOblique', 'sans-serif'],
        'quotebold': ['Finador-BoldOblique', 'sans-serif'],
      },
      fontSize: {
        "title0": ['64px', '68px'],
        "title1": ['50px', '55px'],
        ...
        "link": ['16px', '24px'],
        "quotelarge": ['32px', '44px'],
        "quotesmall": ['20px', '28px'],
      },
      maxWidth: {
        "card": "376px",
        "form": "400px"
